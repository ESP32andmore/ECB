...
## Update Notices
10/17/24 - We created a new YAML for the ECB which allows selection of which sensor controls which fan at runtime when in automatic mode. It also adds Version 3 of the Webserver. [ESPhome/ecb1.yaml](https://github.com/ESP32andmore/ECB/blob/main/ESPhome/ecb1.yaml)
